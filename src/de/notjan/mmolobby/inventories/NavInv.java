...
public class NavInv {
    ...
    public static void NavInvBefüllen() {
        navInv.setItem(4, new ItemAPI(Material.DIAMOND_SWORD).setName("§e§lSkywars").build());
        ...
        navInv.setItem(29, new ItemAPI(Material.END_PORTAL_FRAME).setName("§9§lCrates").build());
